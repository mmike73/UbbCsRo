...
namespace PcPartsManagerGUI2
{
    public partial class Form1: Form
    {
        ...
        private string childTableName = "Masini", childForeignKey = "marca", parentTableName = "Masini", parentPrimaryKey = "marca";
        ...
        private void Form1_Load()
        {
            ...
            try
            {
                    ...
                    parentAdapter = new SqlDataAdapter($"SELECT marca FROM {parentTableName}", connection);
        ...
        private void reload()
        {
            //empty and refill the datagridviews
        }
