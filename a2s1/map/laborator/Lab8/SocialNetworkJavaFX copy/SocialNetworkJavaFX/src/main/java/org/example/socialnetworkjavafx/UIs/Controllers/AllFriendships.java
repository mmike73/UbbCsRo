...
//        this.allFriendships = controller.getAllFriendships();
//        int pageCount = (int) Math.ceil((double) allFriendships.size() / rowsPerPage);
//        pagination.setPageCount(pageCount);
//        int crt = pagination.getCurrentPageIndex();
//        int fromIndex = pageIndex * rowsPerPage;
//        int toIndex = Math.min(fromIndex + rowsPerPage, allFriendships.size());
//        ObservableList<Friendship> pageData = FXCollections.observableArrayList(allFriendships.subList(fromIndex, toIndex));
//        friendshipsTable.setItems(pageData);
