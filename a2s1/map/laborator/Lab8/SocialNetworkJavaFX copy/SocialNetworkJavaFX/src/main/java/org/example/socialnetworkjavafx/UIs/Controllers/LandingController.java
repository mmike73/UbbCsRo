...
public class LandingController {
    ...
    @FXML
    private void openLoggedInPage(User loggedInUser) throws IOException {
        try {
            ...
            loggedInController.setController(cliController);
            loggedInController.setUser(loggedInUser);
            loggedInController.init();
    ...
    private void onViewAllFriendships() {
        try {
            ...
            controller.setController(cliController);
