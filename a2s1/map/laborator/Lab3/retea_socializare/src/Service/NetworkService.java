...
public class NetworkService {
    ...
    public void addFriendship(Friendship friendship) throws Exception {
        if (friendshipRepository.findOne(friendship.hashCode()) == null) {
    ...
    public void removeFriendship(String username1, String username2) throws FriendshipNotFoundException {
        Friendship toDelete = friendshipRepository.findOne(friendshipFactory.createFriendship(username1, username2).hashCode());
        if (toDelete != null) {
            friendshipRepository.delete(toDelete.hashCode());
        } else {
