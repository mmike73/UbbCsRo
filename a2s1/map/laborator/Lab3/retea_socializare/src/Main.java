...
public class Main {
    public static void main(String[] args) {
        ...
        UserRepository userRepo = new UserRepository("/Volumes/D/Faculta/A2S1/MAP/Lab/Lab3/retea_socializare/data_storage/users.txt", userValidator);
        FriendshipRepository friendshipRepo = new FriendshipRepository(userRepo, "/Volumes/D/Faculta/A2S1/MAP/Lab/Lab3/retea_socializare/data_storage/friendships.txt", friendshipValidator);
