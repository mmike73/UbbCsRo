...
public class MessageTask extends Task {
    ...
    public String toString() {
        return "id=" + this.getTaskId() + " | description=" + this.getDescription() + " | message= " + this.getMessage() + " | date and time=" + this.getDate() + " | from=" + this.getFrom() + " | to=" + this.getTo() +  " | from=" + this.getFrom() + " | to=" + this.getTo();
    }
}
