Codul e scris in c, nu in c++ stiu ca in mod normal compileaza 
dar atat eu cat si alti colegi am avut probleme la compilare
/* Colorarea unui graf cu un numãr dat de culori */
